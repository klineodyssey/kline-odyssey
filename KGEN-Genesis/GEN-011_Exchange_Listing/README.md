...
| File | Purpose |
|---|---|
| `KGEN_Exchange_Listing_V1.0.md` | Official Markdown source edition. This is the canonical editable text for this book. |
| `KGEN_Exchange_Listing_V1.0.docx` | DOCX synchronized from Markdown for publication, review, and external sharing. |
| `KGEN_Exchange_Listing_V1.0.pdf` | PDF synchronized from Markdown for official reading and archive distribution. |
