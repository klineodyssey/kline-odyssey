...
整理 BscScan、CoinMarketCap、CoinGecko、GeckoTerminal、PancakeSwap、官方連結與審核材料。

## Files

| File | Purpose |
|---|---|
| `KGEN_Exchange_Listing_V1.0.md` | Official Markdown source edition. |
| `KGEN_Exchange_Listing_V1.0.docx` | DOCX generated from the Markdown edition for publication and review. |
| `KGEN_Exchange_Listing_V1.0.pdf` | PDF generated from the Markdown edition for distribution and review. |
