# GEN-011 《KGEN Exchange Listing》

**中文題名：** KGEN 交易所與資料平台登錄規格  
...
|---|---|
| Document ID | GEN-011 |
| UUID | 9d1109b1-f38f-5d4b-96a8-ed12132595b0 |
| Title | KGEN Exchange Listing / KGEN 交易所與資料平台登錄規格 |
| Version | V1.0 |
| Status | Official V1.0 Full Canon Set |
| Level | L5 Implementation |
| Author | PrimeForge / 樂天帝 ⌖ |
| Maintainer | KLINE ODYSSEY / PrimeForge |
| GitHub Path | KGEN-Genesis/GEN-011_Exchange_Listing/KGEN_Exchange_Listing_V1.0.md |
| Last Update | 2026-07-09 |

## Document Purpose

補完 BscScan、CoinMarketCap、CoinGecko、GeckoTerminal、DexScreener 所需資料格式、Logo、Whitepaper、Social、Contract、Supply、Fair Launch、Proof 與審核注意事項。
...
| GEN-011 | KGEN Exchange Listing / KGEN 交易所與資料平台登錄規格 | L5 Implementation | [KGEN_Exchange_Listing_V1.0.md](./KGEN_Exchange_Listing_V1.0.md) |
...
1. Chapter 1 / 第1章 Listing 總綱
2. Chapter 2 / 第2章 平台資料欄位
3. Chapter 3 / 第3章 BscScan
4. Chapter 4 / 第4章 CoinMarketCap
5. Chapter 5 / 第5章 CoinGecko
6. Chapter 6 / 第6章 GeckoTerminal / DexScreener
7. Chapter 7 / 第7章 Logo 與資產
8. Chapter 8 / 第8章 Whitepaper
9. Chapter 9 / 第9章 Social Links
10. Chapter 10 / 第10章 Contract / Supply
11. Chapter 11 / 第11章 Fair Launch Proof
12. Chapter 12 / 第12章 風險揭露
13. Chapter 13 / 第13章 補件流程
...
## Chapter 1 / 第1章 Listing 總綱

本章確立《KGEN 交易所與資料平台登錄規格》在 KGEN Genesis Library V1.0 中的正式位置。本書不是暫時筆記，也不是單頁說明，而是可被官網、GitHub、AI、SDK、Whitepaper、CMC、CoinGecko、BscScan 與社群資料引用的官方典藏文件。

本書的權限為 **L5 Implementation**。它服務的讀者包含：平台登錄維護者、社群管理者、外部審核者與官方資訊整理者。。它的核心任務是：補完 BscScan、CoinMarketCap、CoinGecko、GeckoTerminal、DexScreener 所需資料格式、Logo、Whitepaper、Social、Contract、Supply、Fair Launch、Proof 與審核注意事項。

本書的權威邊界是：本書整理外部資料平台需要的一致資料包，必須對齊合約與 final-whitepaper。 若本書與下層實作衝突，應先檢查 GEN-001、GEN-002、GEN-004、Runtime CURRENT 與實作文件，再決定是修正文案、更新索引，或退回該實作。

## Chapter 2 / 第2章 平台資料欄位
...
對本書而言，這套哲學落在以下具體命題：補完 BscScan、CoinMarketCap、CoinGecko、GeckoTerminal、DexScreener 所需資料格式、Logo、Whitepaper、Social、Contract、Supply、Fair Launch、Proof 與審核注意事項。 因此本書不能只列項目，它必須說明定義、規則、案例、流程、限制與風險。

## Chapter 3 / 第3章 BscScan

本章定義本書使用的官方詞彙。所有詞彙都必須回到 Genesis、Canon、Constitution、Runtime CURRENT 與 Universe Map，不得各自發明互相衝突的語言。

| Term | Definition |
|---|---|
| Listing Package | 登錄資料包，包含合約、供應量、Logo、白皮書、官網、社群、LP、風險聲明與公平啟動證明。 |
| Proof | 可驗證證據，如 GitHub 路徑、BscScan 合約、LP Pair、Pages URL 與白皮書 PDF。 |
| Data Consistency | 資料一致性，所有平台欄位必須一致，不得一處寫可改稅、一處寫不可改稅。 |
...
## Chapter 6 / 第6章 GeckoTerminal / DexScreener
...
案例：若 BscScan 詢問 token logo，提供 raw SVG 與 GitHub Pages SVG，並提供高解析 logo.png 作輔助。

## Chapter 9 / 第9章 Social Links
...
## Chapter 10 / 第10章 Contract / Supply
...
## Chapter 11 / 第11章 Fair Launch Proof

本章把本書落到檔案與流程。正式 Markdown 路徑為 `KGEN-Genesis/GEN-011_Exchange_Listing/KGEN_Exchange_Listing_V1.0.md`，同步 DOCX 與 PDF 位於同一目錄。每本書的 README 說明檔案用途，assets/README.md 說明資產狀態。
...
案例：若 CoinGecko 詢問社群連結，提供 Website、GitHub、Telegram、X、YouTube 與白皮書 PDF。

## Chapter 12 / 第12章 風險揭露
...
本書風險焦點：外部平台可能延遲、拒絕或要求補件；本文件提供資料規格，不保證平台審核結果。

限制：不得提交與合約不同的供應量、稅率或 decimals。; 不得承諾上市、價格、交易量或收益。; 不得使用未登錄 Logo 或錯誤神殿圖。。任何違反限制的內容都應被標記、退回或修正，而不是直接合併進正式典藏。
...
- BscScan、CMC、CoinGecko、GeckoTerminal、DexScreener 使用同一官方名稱、符號、合約與供應量。
- Logo 必須使用官方資產；32x32 SVG 用於小尺寸平台，logo.png 用於高解析預覽。
- Fair Launch 統一寫法：No ICO / No IEO / No Presale。

本書流程：資料收集 → 合約核對 → Logo 檢查 → 白皮書路徑 → 社群路徑 → 風險聲明 → 平台提交 → 回覆補件。
...
本文件可獨立閱讀。讀者即使尚未讀過其他 GEN 文件，也可以透過本書理解 KGEN 交易所與資料平台登錄規格 的定義、規則、流程、限制與風險；若需要查證來源，請依 Dependencies 與 Related Documents 追溯。
