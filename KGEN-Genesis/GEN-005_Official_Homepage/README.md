...
定義官方網站、Universe Portal、首頁敘事、外部審核連結與公開資訊架構。

## Files

| File | Purpose |
|---|---|
| `KGEN_Official_Homepage_V1.0.md` | Official Markdown source edition. |
| `KGEN_Official_Homepage_V1.0.docx` | DOCX generated from the Markdown edition for publication and review. |
| `KGEN_Official_Homepage_V1.0.pdf` | PDF generated from the Markdown edition for distribution and review. |
