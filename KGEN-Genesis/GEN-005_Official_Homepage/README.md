# GEN-005 KGEN Official Homepage / KGEN 官方首頁規格
...
| File | Purpose |
|---|---|
| `KGEN_Official_Homepage_V1.0.md` | Official Markdown source edition. This is the canonical editable text for this book. |
| `KGEN_Official_Homepage_V1.0.docx` | DOCX synchronized from Markdown for publication, review, and external sharing. |
| `KGEN_Official_Homepage_V1.0.pdf` | PDF synchronized from Markdown for official reading and archive distribution. |
