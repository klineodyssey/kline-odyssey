# GEN-005 《KGEN Official Homepage》
...
|---|---|
| Document ID | GEN-005 |
| UUID | 27eb9566-efc6-50d0-aa70-edafc71e928b |
| Title | KGEN Official Homepage / KGEN 官方首頁規格 |
| Version | V1.0 |
| Status | Official V1.0 Full Canon Set |
| Level | L5 Implementation |
| Author | PrimeForge / 樂天帝 ⌖ |
| Maintainer | KLINE ODYSSEY / PrimeForge |
| GitHub Path | KGEN-Genesis/GEN-005_Official_Homepage/KGEN_Official_Homepage_V1.0.md |
| Last Update | 2026-07-09 |

## Document Purpose

補完官網資訊架構、首頁內容規範、白皮書入口、神殿入口、交易入口、社群入口、BscScan/CMC/CoinGecko 審核資訊規範。
...
| GEN-005 | KGEN Official Homepage / KGEN 官方首頁規格 | L5 Implementation | [KGEN_Official_Homepage_V1.0.md](./KGEN_Official_Homepage_V1.0.md) |
...
1. Chapter 1 / 第1章 官網定位
2. Chapter 2 / 第2章 首頁資訊架構
3. Chapter 3 / 第3章 Hero 與品牌訊息
4. Chapter 4 / 第4章 白皮書入口
5. Chapter 5 / 第5章 神殿入口
6. Chapter 6 / 第6章 交易入口
7. Chapter 7 / 第7章 社群入口
8. Chapter 8 / 第8章 Universe Map 入口
9. Chapter 9 / 第9章 審核資料區
10. Chapter 10 / 第10章 SEO 與公開敘事
11. Chapter 11 / 第11章 頁面治理
12. Chapter 12 / 第12章 內容風險
13. Chapter 13 / 第13章 更新流程
...
本章確立《KGEN 官方首頁規格》在 KGEN Genesis Library V1.0 中的正式位置。本書不是暫時筆記，也不是單頁說明，而是可被官網、GitHub、AI、SDK、Whitepaper、CMC、CoinGecko、BscScan 與社群資料引用的官方典藏文件。

本書的權限為 **L5 Implementation**。它服務的讀者包含：官網維護者、前端設計者、Listing 準備者、社群管理者與平台審核者。。它的核心任務是：補完官網資訊架構、首頁內容規範、白皮書入口、神殿入口、交易入口、社群入口、BscScan/CMC/CoinGecko 審核資訊規範。

本書的權威邊界是：本書定義官方網站作為 Universe Portal 的內容與資訊揭露標準。 若本書與下層實作衝突，應先檢查 GEN-001、GEN-002、GEN-004、Runtime CURRENT 與實作文件，再決定是修正文案、更新索引，或退回該實作。

## Chapter 2 / 第2章 首頁資訊架構
...
對本書而言，這套哲學落在以下具體命題：補完官網資訊架構、首頁內容規範、白皮書入口、神殿入口、交易入口、社群入口、BscScan/CMC/CoinGecko 審核資訊規範。 因此本書不能只列項目，它必須說明定義、規則、案例、流程、限制與風險。

## Chapter 3 / 第3章 Hero 與品牌訊息

本章定義本書使用的官方詞彙。所有詞彙都必須回到 Genesis、Canon、Constitution、Runtime CURRENT 與 Universe Map，不得各自發明互相衝突的語言。

| Term | Definition |
|---|---|
| Universe Portal | 官方首頁不是普通介紹頁，而是進入 KGEN 宇宙、神殿、白皮書、交易與社群的入口。 |
| Public Review Surface | 外部平台與新使用者檢查 KGEN 的公開資訊表面。 |
| Canonical Link | 官方連結；必須指向已確認的 GitHub、Pages、BscScan、GeckoTerminal、社群與白皮書路徑。 |
...
案例：若首頁新增神殿卡片，卡片必須遵守一圖一神殿，不得讓 12345 與 16888 共用同一正式圖片。
...
## Chapter 11 / 第11章 頁面治理

本章把本書落到檔案與流程。正式 Markdown 路徑為 `KGEN-Genesis/GEN-005_Official_Homepage/KGEN_Official_Homepage_V1.0.md`，同步 DOCX 與 PDF 位於同一目錄。每本書的 README 說明檔案用途，assets/README.md 說明資產狀態。
...
案例：若首頁加入交易按鈕，必須同時提供 BscScan、PancakeSwap、GeckoTerminal 與風險聲明。

## Chapter 12 / 第12章 內容風險
...
本書風險焦點：官網是資訊入口，不是投資招募頁，也不保證任何第三方平台審核通過。

限制：不得把首頁寫成普通 GitHub README 樣式。; 不得使用不明來源或混用神殿圖像。; 不得承諾價格、收益或平台審核結果。。任何違反限制的內容都應被標記、退回或修正，而不是直接合併進正式典藏。
...
- 首頁必須保留 KLINE ODYSSEY、KGEN 宇宙文明生命引擎與 Where the Market Becomes the Myth。
- 首頁必須提供白皮書、Universe Map、12345、YouTube、Token Dashboard、Community 與 Donate/Support 入口。
- 任何外部審核資訊不得和 KGEN_Token_V7_5_2.sol 或 final-whitepaper 衝突。

本書流程：首頁 Hero → Universe Map → 神殿入口 → 白皮書 → Token Dashboard → Community → Support → Footer Canon。
...
本文件可獨立閱讀。讀者即使尚未讀過其他 GEN 文件，也可以透過本書理解 KGEN 官方首頁規格 的定義、規則、流程、限制與風險；若需要查證來源，請依 Dependencies 與 Related Documents 追溯。
