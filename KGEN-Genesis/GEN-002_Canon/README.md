...
| File | Purpose |
|---|---|
| `KGEN_Canon_V1.0.md` | Official Markdown source edition. |
| `KGEN_Canon_V1.0.docx` | DOCX generated from the Markdown edition for publication and review. |
| `KGEN_Canon_V1.0.pdf` | PDF generated from the Markdown edition for distribution and review. |
