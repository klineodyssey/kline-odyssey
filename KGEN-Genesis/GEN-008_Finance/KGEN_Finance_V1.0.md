...
|---|---|
| Document ID | GEN-008 |
| UUID | 6f5681ec-c29f-584b-b198-93ddffababf3 |
| Title | KGEN Finance / KGEN 金融系統 |
| Version | V1.0 |
| Status | Official V1.0 Full Canon Set |
| Level | L3 Design Bible |
| Author | PrimeForge / 樂天帝 ⌖ |
| Maintainer | KLINE ODYSSEY / PrimeForge |
| GitHub Path | KGEN-Genesis/GEN-008_Finance/KGEN_Finance_V1.0.md |
...
| GEN-008 | KGEN Finance / KGEN 金融系統 | L3 Design Bible | [KGEN_Finance_V1.0.md](./KGEN_Finance_V1.0.md) |
...
1. Chapter 1 / 第1章 金融總綱
2. Chapter 2 / 第2章 KGEN Token
3. Chapter 3 / 第3章 合約常數
4. Chapter 4 / 第4章 AMM Tax
5. Chapter 5 / 第5章 Burn / Bank / Reward / AutoLP
6. Chapter 6 / 第6章 Wallet-to-wallet no tax
7. Chapter 7 / 第7章 11520 花果山交易所
8. Chapter 8 / 第8章 神明銀行
9. Chapter 9 / 第9章 文明資產
10. Chapter 10 / 第10章 Fair Launch
11. Chapter 11 / 第11章 平台揭露
12. Chapter 12 / 第12章 風險聲明
13. Chapter 13 / 第13章 治理
...
本章確立《KGEN 金融系統》在 KGEN Genesis Library V1.0 中的正式位置。本書不是暫時筆記，也不是單頁說明，而是可被官網、GitHub、AI、SDK、Whitepaper、CMC、CoinGecko、BscScan 與社群資料引用的官方典藏文件。

本書的權限為 **L3 Design Bible**。它服務的讀者包含：投資資訊審核者、Listing 準備者、社群管理者、遊戲經濟設計者與合約讀者。。它的核心任務是：補完 KGEN Token、BEP-20、Total Supply 72,000,000、Decimals 18、AMM tax 0.30%、Burn/Bank/Reward/AutoLP、Wallet-to-wallet no tax、11520 交易所、風險聲明與 Fair Launch。

本書的權威邊界是：本書必須對齊 KGEN_Token_V7_5_2.sol 與 V4.0 final-whitepaper。 若本書與下層實作衝突，應先檢查 GEN-001、GEN-002、GEN-004、Runtime CURRENT 與實作文件，再決定是修正文案、更新索引，或退回該實作。

## Chapter 2 / 第2章 KGEN Token
...
對本書而言，這套哲學落在以下具體命題：補完 KGEN Token、BEP-20、Total Supply 72,000,000、Decimals 18、AMM tax 0.30%、Burn/Bank/Reward/AutoLP、Wallet-to-wallet no tax、11520 交易所、風險聲明與 Fair Launch。 因此本書不能只列項目，它必須說明定義、規則、案例、流程、限制與風險。
...
| Term | Definition |
|---|---|
| KGEN Token | KLINE GENESIS，BEP-20 token，部署於 BNB Smart Chain。 |
| AMM Tax | 只在 AMM buy/sell 互動發生的 0.30% 稅率。 |
| 11520 花果山交易所 | App、土地、神殿、AI、DNA 與文明資產的交易中心概念。 |
...
## Chapter 5 / 第5章 Burn / Bank / Reward / AutoLP
...
## Chapter 6 / 第6章 Wallet-to-wallet no tax
...
案例：一般玩家把 KGEN 轉給另一個錢包，不進 AMM pair，依合約規則無交易稅。
...
## Chapter 11 / 第11章 平台揭露

本章把本書落到檔案與流程。正式 Markdown 路徑為 `KGEN-Genesis/GEN-008_Finance/KGEN_Finance_V1.0.md`，同步 DOCX 與 PDF 位於同一目錄。每本書的 README 說明檔案用途，assets/README.md 說明資產狀態。
...
案例：AMM buy/sell 經 market maker pair 觸發，才依 30 bps 分配 Burn、Bank、Reward、AutoLP。

## Chapter 12 / 第12章 風險聲明
...
本書風險焦點：KGEN 是鏈上數位資產，可能面臨市場波動、流動性不足、智能合約風險、監管不確定性與全部損失風險。

限制：不得宣稱稅率可任意調整。; 不得宣稱 KGEN 保證收益。; 不得把 11520 寫成已完成的中心化交易所。。任何違反限制的內容都應被標記、退回或修正，而不是直接合併進正式典藏。
...
- Name: KLINE GENESIS；Symbol: KGEN；Chain: BNB Smart Chain；Standard: BEP-20；Total Supply: 72,000,000 KGEN；Decimals: 18。
- Tax: 0.30% only on AMM buy/sell；Burn 0.10%、Bank 0.10%、Reward 0.05%、AutoLP 0.05%。
- Wallet-to-wallet transfers: no tax；Fair Launch: No ICO / No IEO / No Presale。

本書流程：資源 → 交易 → KGEN → 神殿服務 → 文明科技 → 11520 市場 → 再投資文明建設。
...
本文件可獨立閱讀。讀者即使尚未讀過其他 GEN 文件，也可以透過本書理解 KGEN 金融系統 的定義、規則、流程、限制與風險；若需要查證來源，請依 Dependencies 與 Related Documents 追溯。
