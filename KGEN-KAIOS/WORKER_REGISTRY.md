...
Current bounded claim: `KAIOS-CURSOR-CROP-LIFE-PACKAGES-001` on
`cursor-handoff/KAIOS-CURSOR-CROP-LIFE-PACKAGES-001`. The preceding forest
claim is `RELEASED`; crop is the only lock-holding task.
