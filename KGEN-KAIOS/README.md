...
| `governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_FUNGI_RELEASED_MICROBIAL_RESEARCH_DISPATCHED.md` | Company status for the controlled fungi-to-microbial-research transition. |
