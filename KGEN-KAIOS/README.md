...
| KAIOS World Viewer | https://klineodyssey.github.io/kline-odyssey/KGEN-KAIOS/world-viewer/ | Sprint 006 Settlement Economy Alpha: population, family, logistics, KAIOS Credit and gated KGEN/external settlement |
...
| `world-viewer/` | `WORLD-VIEWER-V1.0` + Sprint 006 Settlement Economy Alpha | Frozen Architecture plus executable synthetic 2D living world, Life, production, population, logistics and conserved KAIOS Credit; no real biology, ownership, identity, asset transfer or external settlement |
