...
bank system are live. Phase 2 Stage 1 is complete: all three modules are deployed,
registered inactive, and governed by the formal delayed BankGovernance. KGEN tax routing,
KGEN ownership, module activation, redemption, capital commitment, and eligibility writes
remain unchanged or disabled.
...
| `frontend-adapter/lingxiao18888BankAdapter.mjs` | Read-only 18888/500-seat/8888 status adapter and deterministic action calldata encoder |
...
| KAIOS Real Causal World | https://klineodyssey.github.io/kline-odyssey/world-viewer/causal-runtime/ | Deterministic terrain, route, fuel, wear, construction and economic causality foundation |
...
Human Decision `KAIOS COMPANY AUTOPILOT V1.0` activates Codex as GitHub mainline controller for routine engineering operations. The controlling files are `governance/autopilot/CODEX_MAINLINE_CONTROLLER.md`, `governance/autopilot/codex_mainline_controller.json`, recovery records under `governance/autopilot/recovery_points/`, and daily Company Boot reports under `governance/autopilot/company_status/`. Human escalation remains reserved for universe law, worldbuilding, Token economy, Genesis, PrimeForge Constitution, Universe Map main structure, major product direction, major security incident, irreversible deletion, or explicit stop.
...
| `../KAIOS/life/forest-agriculture/KAIOS_CURSOR_FRUIT_TREE_PACKAGE_REVIEW_CLOSEOUT.md` | Codex review and formal release record for the fruit-tree candidate task. |
| `../KAIOS/life/candidates/forest-agriculture-v1/CURSOR_VEGETABLE_PACKAGES_WORK_ORDER.md` | Candidate-only vegetable task envelope for `cursor-01`. |
| `governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_FRUIT_TREE_RELEASED_VEGETABLE_DISPATCHED.md` | Company status for the controlled fruit-tree-to-vegetable transition. |
| `../KAIOS/life/forest-agriculture/KAIOS_CURSOR_VEGETABLE_PACKAGE_REVIEW_CLOSEOUT.md` | Codex review and formal release record for the vegetable candidate task. |
| `../KAIOS/life/candidates/forest-agriculture-v1/CURSOR_SOIL_TYPES_WORK_ORDER.md` | Candidate-only soil-type task envelope for `cursor-01`. |
| `governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_VEGETABLE_RELEASED_SOIL_TYPES_DISPATCHED.md` | Company status for the controlled vegetable-to-soil-types transition. |
...
| `../KAIOS/life/candidates/forest-agriculture-v1/CURSOR_INSECT_CANDIDATES_WORK_ORDER.md` | Candidate-only insect package task envelope for `cursor-01`. |
| `governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_COMPOST_RELEASED_INSECT_CANDIDATES_DISPATCHED.md` | Company status for the controlled compost-to-insect transition. |
...
| `../KAIOS/life/forest-agriculture/KAIOS_CURSOR_EARTHWORM_CANDIDATE_REVIEW_CLOSEOUT.md` | Codex review and release record for the earthworm candidate. |
| `../KAIOS/life/candidates/forest-agriculture-v1/CURSOR_FUNGI_CANDIDATE_WORK_ORDER.md` | Candidate-only fungi task envelope for `cursor-01`. |
