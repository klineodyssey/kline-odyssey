...
| `governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_MICROBIAL_RESEARCH_MANUAL_CLAIM.md` | Company status for the reviewed pre-cutover manual non-atomic Microbial research claim. |
