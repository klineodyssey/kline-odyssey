...
| KAIOS World Viewer | https://klineodyssey.github.io/kline-odyssey/KGEN-KAIOS/world-viewer/ | Sprint 008 Cambrian Explosion Alpha: 9-rank taxonomy, Species Registry, Genome/DNA, 108 GA, Food Chain V2 and planet ecology |
...
| `world-viewer/` | `WORLD-VIEWER-V1.0` + Sprint 008 Cambrian Explosion Alpha | Frozen Architecture plus executable synthetic 2D living world, universal Biology Foundation, Food Chain V2, civilization, economy and governance; no real biology, authority, identity, asset transfer or external settlement |
