...
| Company operational queues, internal review evidence and non-public financial/HR operations | KAIOS AI Company | `INTERNAL` | No by default | Yes | No unless credentials appear | KAIOS AI Company | Yes when it reveals no private state |
