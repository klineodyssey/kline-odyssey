...
- `HUMAN_PACKAGE/KAIOS_Chapter_24_Cosmic_Ecology_Natural_Selection_Species_Exchange_Runtime.md:139` - `18888 花果山` - 18888 = LINGXIAO_CELESTIAL_BANK; the Human package source line is overridden and is not Active Canon.
- `HUMAN_PACKAGE/KAIOS_Chapter_24_Cosmic_Ecology_Natural_Selection_Species_Exchange_Runtime.md:140` - `11520 Heaven` - 11520 = HUAGUO_UNIVERSE_EXCHANGE; the Human package source line is overridden and is not Active Canon.
...
- `KGEN-KAIOS/KAIOS_MULTICIVILIZATION_RELIGIOUS_NEUTRALITY_LIFE_MIGRATION_RUNTIME_V1.0.md`
- `KGEN-KAIOS/archive/KAIOSV01_BurnProofGenesis_DRAFT_ARCHIVE.md`
- `KGEN-KAIOS/archive/KAIOS_CELESTIAL_BANK_CONSERVATION_WHITEPAPER_V1.2_ARCHIVE.md`
- `KGEN-KAIOS/archive/KAIOS_CELESTIAL_BANK_CONSERVATION_WHITEPAPER_V1.3_ARCHIVE.md`
- `KGEN-KAIOS/reports/KAIOS_TOKEN_LINEAGE_INTEGRATION_CLOSEOUT_20260809.md`
...
| SUPERSEDED_HISTORY | `KGEN-KAIOS/archive/KAIOS_CELESTIAL_BANK_CONSERVATION_WHITEPAPER_V1.2_ARCHIVE.md:16` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `KGEN-KAIOS/archive/KAIOS_CELESTIAL_BANK_CONSERVATION_WHITEPAPER_V1.3_ARCHIVE.md:18` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `KGEN-KAIOS/archive/KAIOS_CELESTIAL_BANK_CONSERVATION_WHITEPAPER_V1.3_ARCHIVE.md:19` | 10_000_KAIOS | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| CURRENT_CORRECT | `KGEN-KAIOS/contracts/KAIOS.sol:46` | KAIOS_PER_KGEN | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/contracts/KAIOS.sol:53` | MAX_SUPPLY | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/contracts/KAIOS.sol:129` | MAX_SUPPLY | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/contracts/KAIOS.sol:170` | KAIOS_PER_KGEN | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/contracts/KAIOS.sol:288` | KAIOS_PER_KGEN | Identifier occurrence; numeric value audited independently. |
...
| CURRENT_CORRECT | `KGEN-KAIOS/operations/KAIOS_CIVILIZATION_PHASE2_RUNBOOK.md:14` | 10_000_KAIOS | Operational KAIOS cap/limit; not a KGEN-to-KAIOS conversion definition. |
...
| TEST_FIXTURE | `KGEN-KAIOS/tests/token-surface.security.test.mjs:257` | TEN_THOUSAND_KAIOS | Negative regression fixture; it must assert rejection of the legacy inscription or scale. |
...
| COMMENT_ONLY | `KGEN-KAIOS/tools/generate-stale-reference-audit.mjs:111` | KAIOS_PER_KGEN | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| CURRENT_CORRECT | `KGEN-KAIOS/tools/generate-stale-reference-audit.mjs:296` | MAX_SUPPLY | Identifier occurrence; numeric value audited independently. |
| COMMENT_ONLY | `KGEN-KAIOS/tools/generate-stale-reference-audit.mjs:343` | 1_TO_10_000 | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| CURRENT_CORRECT | `KGEN-KAIOS/tools/generate-stale-reference-audit.mjs:350` | MAX_SUPPLY | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/tools/rehearse-kaios-civilization-phase2-mainnet-fork.mjs:324` | 10_000_KAIOS | Operational KAIOS cap/limit; not a KGEN-to-KAIOS conversion definition. |
...
| CURRENT_CORRECT | `KGEN-KAIOS/tools/validate-integration-artifacts.mjs:70` | KAIOS_PER_KGEN | Identifier occurrence; numeric value audited independently. |
| CURRENT_CORRECT | `KGEN-KAIOS/tools/validate-integration-artifacts.mjs:119` | KAIOS_PER_KGEN | Identifier occurrence; numeric value audited independently. |
...
| CURRENT_CORRECT | `KGEN/registry/CoinMarketCap/test_kgen_cmc_listing_package.py:201` | MAX_SUPPLY | Identifier occurrence; numeric value audited independently. |
| COMMENT_ONLY | `K線西遊記/daily/2026-01-21/subtitle_en.srt:42` | 1_TO_10_000 | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `K線西遊記/daily/2026-01-21/subtitle_en.srt:47` | 1_TO_10_000 | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `K線西遊記/daily/20260129/悟空新文_Weight_of_the_World/Wukong_Essay_Weight_Not_Smart_subtitle_en.srt:39` | 1_TO_10_000 | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `K線西遊記/daily/20260129/悟空新文_Weight_of_the_World/Wukong_Essay_Weight_Not_Smart_subtitle_en.srt:45` | 1_TO_10_000 | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `docs/physics/KGEN_KAIOS_SCALE_AND_PLANCK_RUNTIME_CURRENT.md:202` | 10_000_KAIOS | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `docs/physics/final-whitepaper/KGEN_Universe_Physics_PreSpacetime_WhiteHole_AngularMomentum.md:42` | 10_000_KAIOS | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `docs/physics/final-whitepaper/KGEN_Universe_Physics_PreSpacetime_WhiteHole_AngularMomentum.md:383` | 10_000_KAIOS | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| COMMENT_ONLY | `docs/physics/final-whitepaper/KGEN_Universe_Physics_PreSpacetime_WhiteHole_AngularMomentum.md:384` | 720_BILLION_FORMATTED | Audit, supersession, or negative-reference text; not an executable monetary definition. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:2` | 1_TO_10_000 | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:140` | 10_000_KAIOS | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:155` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:164` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:165` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:264` | 10_000_KAIOS | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:266` | 10_000_KAIOS | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:759` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:974` | 720_BILLION_FORMATTED | Historical bytes are retained behind an explicit SUPERSEDED marker. |
| SUPERSEDED_HISTORY | `docs/whitepaper/18888_Celestial_Autonomous_Bank_Whitepaper_V1.0_Genesis_Edition.md:976` | 10_000_KAIOS | Historical bytes are retained behind an explicit SUPERSEDED marker. |
