...
async function snapshot(provider, plan) {
  ...
  return {
    ...
    bank8888: {
      ...
      paymentLiability: formatUnits(await bank8888.totalPaymentLiability(), 18),
      totalCustomerLiability: formatUnits(await bank8888.totalCustomerLiability(), 18),
      ...
      currentBankingEpoch: (await bank8888.currentBankingEpoch()).toString(),
      ...
      payroll: {
        ...
        claimableAt: (await bank8888.epochClaimableAt(payroll.epoch)).toString(),
