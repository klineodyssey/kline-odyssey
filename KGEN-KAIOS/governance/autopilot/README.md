...
| `recovery_points/RECOVERY-PR51-KGEN-BSCSCAN-LOGO-V1.md` | PR #51 BscScan logo package recovery anchor |
| `company_status/COMPANY_STATUS_2026-07-26_PR51_BSCSCAN_LOGO.md` | Post-merge Company Status for PR #51 |
...
| `company_status/COMPANY_STATUS_2026-08-02_FRUIT_TREE_RELEASED_VEGETABLE_DISPATCHED.md` | Fruit-tree candidate release and sole active vegetable candidate dispatch |
| `company_status/COMPANY_STATUS_2026-08-02_VEGETABLE_RELEASED_SOIL_TYPES_DISPATCHED.md` | Vegetable candidate release and sole active soil-type candidate dispatch |
| `company_status/COMPANY_STATUS_2026-08-02_SOIL_TYPES_RELEASED_FERTILIZER_MODELS_DISPATCHED.md` | Soil candidate release and sole active fertilizer-model research dispatch |
...
| `company_status/COMPANY_STATUS_2026-08-02_FUNGI_RELEASED_MICROBIAL_READY_FOR_ATOMIC_CLAIM.md` | Fungi candidate release and prepared microbial decomposer research envelope |
| `company_status/COMPANY_STATUS_2026-08-02_MICROBIAL_RESEARCH_MANUAL_CLAIM.md` | Sole reviewed Microbial research claim under the pre-cutover manual non-atomic dispatch rule |
