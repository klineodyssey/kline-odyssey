...
| KAIOS World Viewer | [KGEN-KAIOS/world-viewer/](KGEN-KAIOS/world-viewer/) | https://klineodyssey.github.io/kline-odyssey/world-viewer/ |
...
- One Command Start: [KGEN-AI-Company/CURSOR_ONE_COMMAND_START.md](KGEN-AI-Company/CURSOR_ONE_COMMAND_START.md)
...
<a href="https://klineodyssey.github.io/kline-odyssey/K線西遊記/temples/12345/index.html"
   style="display:inline-flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;font-weight:900;text-decoration:none;border:1px solid #111;background:#fff;">
  🐒五指山 12345・悟空財神殿 
</a>
...
👉 KGEN 白皮書（官網直達）：[點我進入](https://klineodyssey.github.io/kline-odyssey/KGEN/whitepaper/)

👉 正式制度白皮書（V7.5.2）：[點我閱讀](https://klineodyssey.github.io/kline-odyssey/KGEN/whitepaper/KGEN_Whitepaper_GalacticBank_500Y_Epoch_V7.5.2.html)
...
- [Vegetable Candidate Codex Review Closeout](KAIOS/life/forest-agriculture/KAIOS_CURSOR_VEGETABLE_PACKAGE_REVIEW_CLOSEOUT.md)
- [Soil Type Candidate Cursor Work Order](KAIOS/life/candidates/forest-agriculture-v1/CURSOR_SOIL_TYPES_WORK_ORDER.md)
...
- [Fungi Release and Microbial Research Preparation-Only Company Status](KGEN-KAIOS/governance/autopilot/company_status/COMPANY_STATUS_2026-08-02_FUNGI_RELEASED_MICROBIAL_READY_FOR_ATOMIC_CLAIM.md)

### KAIOS Software Life

- [Software Life Center](KAIOS/software-life/README.md)
- [Naming Audit](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_NAMING_AUDIT.json)
- [Naming Audit Report](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_NAMING_AUDIT_REPORT.md)
- [Identity Standard](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_IDENTITY_STANDARD.md)
- [Taxonomy Crosswalk](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_TAXONOMY_CROSSWALK.json)
- [Manifest Schema](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_MANIFEST_SCHEMA.json)
- [Software Life Registry](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_REGISTRY.json)
- [Registry Report](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_REGISTRY_REPORT.md)
...
- [24H Queue](KAIOS/software-life/KAIOS_AI_WORKFORCE_24H_QUEUE.json)
- [Execution Log](KAIOS/software-life/KAIOS_SOFTWARE_LIFE_24H_EXECUTION_LOG.md)
