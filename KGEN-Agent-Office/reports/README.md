...
- `TASK-003_CANON_LOOP_CHECK.md`
- `TASK-004_LISTING_READY_REPORT.md`
- `TASK-005_NEXT_CODEX_PLAN.md`

## Report Governance

Reports may identify issues and propose fixes. Reports must not hide risky changes or claim completion without listing files read, files modified, checks run, risks, and review needs.
