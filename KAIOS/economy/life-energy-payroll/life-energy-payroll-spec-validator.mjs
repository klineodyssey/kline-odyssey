...
assert.equal(dispatch.status, "HOLD_EXPLICIT_HUMAN_AUTHORIZATION_REQUIRED");
...
assert.equal(dispatch.dispatch_mode, "CODEX_CONTROLLED_PREPARATION_ONLY");
...
assert.equal(dispatch.bounded_pilot_policy.authorization_evidence, "NOT_VERIFIED");
