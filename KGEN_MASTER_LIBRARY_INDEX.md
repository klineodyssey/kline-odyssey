...
| KAIOS World Viewer V1.0 + Sprint 005 Civilization Production Alpha | `KGEN-KAIOS/world-viewer/` | Frozen Web-first Architecture plus executable K280 living world, ecology, agriculture, supply chain, Factory and AI Company organisms, K11520 candidates and Product QA |
...
| Item | Path | Purpose |
|---|---|---|
| AI Company Index | `KGEN-AI-Company/README.md` | Codex-managed Cursor automation entry |
...
| KAIOS World Viewer Sprint 005 Civilization Production Alpha | `KGEN-KAIOS/world-viewer/index.html` | Unique static entry for the synthetic K280 map, six-level navigation, responsive Inspector, Life OS, ecosystem, farming, production, AI company, exchange candidates and Product QA |
