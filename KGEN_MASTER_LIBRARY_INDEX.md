...
| KAIOS World Viewer V1.0 + Sprint 006 Settlement Economy Alpha | `KGEN-KAIOS/world-viewer/` | Frozen Web-first Architecture plus executable K280 living world, population, logistics, ecology recovery, conserved KAIOS Credit and gated asset-settlement requests |
...
| KAIOS World Viewer Sprint 006 Settlement Economy Alpha | `KGEN-KAIOS/world-viewer/index.html` | Unique static entry for the synthetic K280 map, responsive Inspector, Life OS, population, production, logistics and three-layer settlement boundary |
