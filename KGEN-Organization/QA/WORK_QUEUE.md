...
|---|---|---|---|
| ORG-QA-001 | OPEN | Read department README, ROLE, RESPONSIBILITY, HANDOFF, and REPORT_TEMPLATE | Department readiness note |
| ORG-QA-002 | OPEN | Check related Canon links and protected path impact | Department link and risk report |
| ORG-QA-003 | REVIEW | Propose next department-specific WorkOrder without changing core systems | Proposal for Codex Review |
