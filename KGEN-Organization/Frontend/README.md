...
**Department Path:** KGEN-Organization/Frontend/  
**Status:** Active / Draft for Review  
**Reports To:** CEO_Codex  
**Works With:** Temple、Universe、Game、Publishing、QA

## Department Position

Frontend 管理首頁、Portal、神殿入口、UI 樹、手機版與可讀性。
...
不得改 12345 正式程式除非任務明確指定；不得新增版本號正式器官檔。
