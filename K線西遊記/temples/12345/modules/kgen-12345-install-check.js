/* KGEN 12345 V10.37.9 Install / Organ Check */
(function(){
  'use strict';
  ...
  async function run(){
    ...
    const box=statusBox();
    if(missing.length){
      box.innerHTML='<b>V10.37.9 器官檢查：</b><span class="bad">缺檔 / 缺節點：</span> '+missing.join('、');
      speak('五指山器官檢查發現缺檔，請檢查檔案路徑。');
    }else{
      box.innerHTML='<b>V10.37.9 器官檢查：</b><span class="ok">OK</span>｜CY/WARP 分離｜modules '+loaded.join('+');
    }
  }
