...
const hostile={id:'MON-QA',lifeId:'LIFE-MON-QA',species:'BULL_DEMON',state:'OBSERVE',attack:7,speed:.01,x:4,y:0,z:0,lastAttackAt:0,marketRelation:null,marketLife:{world:{position:{x:4,y:0,z:0}}}};
...
applyMarketLifeSourceEvents(world,[{type:'SPAWN',sourceId:'QA-MONSTER',lifeId:'LIFE-QA-BULL-ATTACK',name:'QA 牛魔王',species:'BULL_DEMON',intelligence:4,markets:[],capital:0,vitality:100,maxHp:100,attack:7,rewardKaios:0,speed:.01,positions:{},x:1,y:0,z:0}]);
