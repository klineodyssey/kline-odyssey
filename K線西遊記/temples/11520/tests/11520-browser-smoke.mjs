...
const joyBox=await page.locator('#joy').boundingBox();assert.ok(joyBox);assert.ok(joyBox.x>=0&&joyBox.x+joyBox.width<=390,`XZ joystick is outside the mobile viewport: ${JSON.stringify(joyBox)}`);
