...
function install(){
  ...
  const panel=document.createElement('section');panel.id='backpackPanel';panel.innerHTML=`<div class="bpHead"><b>🎒 花果山背包 · 3D 物品識別</b><button id="backpackClose">×</button></div><div class="bpStats" id="backpackStats"></div><div class="bpNotice" id="backpackNotice" hidden></div><div class="bpGrid" id="backpackGrid"></div><div class="bpHint">物品與角色採同一原則：先看 3D 外形即可辨識類型，再用名稱與 LIFE_ID／貨物資訊確認。寶物、材料、食物、KGEN、KAIOS/現鈔與活體貨箱使用不同幾何語言。</div>`;document.body.appendChild(panel);
