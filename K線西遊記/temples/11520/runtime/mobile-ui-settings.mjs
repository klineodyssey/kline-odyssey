...
PURPOSE: One lower-right settings console owns HUD visibility. Legacy scattered drawer toggles are retired from the visible UI; chat replaces obsolete Y visibility; wallet and backpack are protected organs and can never be hidden or have their primary mobile hit targets covered by this console. Formal filename is version-free.
*/
