...
function tick(){installStyle();restoreOrSeed();const coords=globalizeLocal(),layout=layoutReport();globalThis.__K11520_MARKET_ORIGIN_RUNTIME__={version:'1.2.0',origin:globalThis.__K11520_MARKET_ORIGIN__||null,global:coords,layout,visibleAuthority:'DATA_ATTRIBUTE_PSEUDO'};return globalThis.__K11520_MARKET_ORIGIN_RUNTIME__}
