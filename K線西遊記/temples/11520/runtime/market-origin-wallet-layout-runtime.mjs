...
PURPOSE: Keep KX/KY/KZ market axes separate from autonomous player XYZ space, reserve the bottom mobile control zone for exactly three readable vertical rails, and keep all utility controls above that zone with a stable reachable wallet valve.
*/
const $=s=>document.querySelector(s);
const LEGACY_MARKET_ORIGIN_KEY='k11520.marketOrigin.v1';
let walletInitial=null;
const MOBILE={dockBottom:218,gameBottom:278,walletBottom:326,aiBottom:374,bgmBottom:422,bagBottom:470,chatBottom:518,masterBottom:570};
...
#walletToggle{position:fixed!important;right:5px!important;top:auto!important;bottom:${MOBILE.walletBottom}px!important;left:auto!important;transform:none!important;z-index:2147483000!important;width:48px!important;height:48px!important;min-width:48px!important;min-height:48px!important;margin:0!important;padding:0!important;display:grid!important;place-items:center!important;pointer-events:auto!important;visibility:visible!important;opacity:1!important;font-size:21px!important;line-height:1!important}
@media(max-width:420px){
  #walletPanel{right:5px!important;left:auto!important}
  #walletPanel.collapsed{right:5px!important;bottom:${MOBILE.walletBottom}px!important;pointer-events:none!important}
  #walletPanel.collapsed #walletToggle{pointer-events:auto!important}
  ...
  #dock{right:5px!important;bottom:${MOBILE.dockBottom}px!important;z-index:500!important}
  #gameModeToggle{position:fixed!important;right:5px!important;left:auto!important;top:auto!important;bottom:${MOBILE.gameBottom}px!important}
  #walletToggle{right:5px!important;bottom:${MOBILE.walletBottom}px!important}
  #aiChatButton{right:5px!important;bottom:${MOBILE.aiBottom}px!important}
  #bgmButton{right:5px!important;bottom:${MOBILE.bgmBottom}px!important}
  #backpackButton,.bagRelocatedV250,.bagRelocatedV258{position:fixed!important;right:5px!important;left:auto!important;top:auto!important;bottom:${MOBILE.bagBottom}px!important;width:42px!important;height:42px!important;z-index:9970!important}
  #chatHandle{position:fixed!important;right:5px!important;left:auto!important;top:auto!important;bottom:${MOBILE.chatBottom}px!important;width:42px!important;height:46px!important;z-index:9960!important;border-left:1px solid #68e4ff66!important;border-radius:13px!important}
  #k11520HudCollapseAll{position:fixed!important;right:5px!important;left:auto!important;top:auto!important;bottom:${MOBILE.masterBottom}px!important;width:42px!important;height:42px!important;z-index:9950!important}
}
`;return s}
function pinWalletToggle(){const b=$('#walletToggle');if(!b)return null;try{globalThis.__K11520_MOBILE_VISUAL_OBSERVER__?.disconnect?.()}catch{}if(b.parentElement!==document.body)document.body.appendChild(b);for(const [k,v] of Object.entries({position:'fixed',right:'5px',top:'auto',bottom:`${MOBILE.walletBottom}px`,left:'auto',transform:'none',zIndex:'2147483000',width:'48px',height:'48px',minWidth:'48px',minHeight:'48px',margin:'0',padding:'0',display:'grid',placeItems:'center',pointerEvents:'auto',visibility:'visible',opacity:'1'}))b.style.setProperty(k.replace(/[A-Z]/g,m=>'-'+m.toLowerCase()),v,'important');b.textContent='💰';b.setAttribute('aria-label',($('#walletPanel')?.classList.contains('collapsed')?'開啟':'關閉')+' 11520 錢包');b.dataset.k11520ViewportPinned='1';return b}
