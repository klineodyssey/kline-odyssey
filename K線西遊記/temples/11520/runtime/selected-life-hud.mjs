/* KGEN_META
VERSION: 1.2.0
REVISION: 2026-09-09.READABLE-CANONICAL-SHEET-BRIDGE
STATUS: CANDIDATE
...
function ensurePanel(){if(typeof document==='undefined')return null;let p=document.getElementById(PANEL_ID);if(p)return p;p=document.createElement('section');p.id=PANEL_ID;p.hidden=true;p.setAttribute('aria-live','polite');p.setAttribute('aria-label','選中生命資訊');p.style.cssText='position:fixed;left:12px;top:auto;bottom:88px;z-index:1250;max-width:min(250px,calc(100vw - 78px));padding:9px 11px;border:1px solid rgba(126,228,255,.78);border-radius:10px;background:rgba(4,17,27,.96);color:#e8fbff;font:600 12px/1.45 system-ui,sans-serif;white-space:pre-line;pointer-events:none;box-shadow:0 8px 26px rgba(0,0,0,.55)';document.body.appendChild(p);return p}
