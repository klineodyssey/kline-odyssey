...
function ensureStyle(){
  ...
  #joy #knob .v252ControlImg{width:100%!important;height:100%!important;display:block!important;object-fit:cover!important;border-radius:50%!important;pointer-events:none!important;user-select:none!important}
  ...
  #yJoyV250 .yKnob{overflow:hidden!important;padding:0!important;background:#071018!important;width:52px!important;height:52px!important;margin:-26px 0 0 -26px!important;border:2px solid #f1ca73!important;box-shadow:0 5px 16px #000a!important;pointer-events:auto!important;touch-action:none!important}
  #yJoyV250 .yKnob .v252ControlImg{width:100%!important;height:100%!important;display:block!important;object-fit:cover!important;object-position:center 18%!important;border-radius:50%!important;pointer-events:none!important;user-select:none!important}

  /* Keep the legacy Y bridge alive off-screen: V2.5.0 drives altitude by dispatching into #yControl.
     display:none gave it a 0x0 rect, so its canonical vertical handler could not compute altitude. */
  ...
  #cControl .thumb .v252ControlImg,#lotsControl .thumb .v252ControlImg{width:100%!important;height:100%!important;display:block!important;object-fit:cover!important;border-radius:50%!important;pointer-events:none!important;user-select:none!important}
  ...
  @media(max-width:420px){
    ...
    #yJoyV250{right:5px!important;width:62px!important;height:128px!important}
    #yJoyV250 .yKnob{width:48px!important;height:48px!important;margin:-24px 0 0 -24px!important}
...
function putImage(host,src,alt){
  ...
  let img=host.querySelector('img.v252ControlImg');
  if(!img){
    host.textContent='';
    img=document.createElement('img');
    img.className='v252ControlImg';
...
function controlHealth(){
  ...
  document.documentElement.dataset.v252ControlHealth=report.ok?'PASS':'RED';
