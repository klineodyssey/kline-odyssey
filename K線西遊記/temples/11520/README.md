...
- The fixed read-only GitHub API transport can attest repository, PR, changed-file and successful exact-head workflow evidence without GitHub mutation capability. This still does not verify proposal authorship or Reviewer independence and cannot activate Company authority.
