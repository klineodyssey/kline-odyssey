...
function defaultStatePath(environment) {
  ...
  return join(base, "KlineOdyssey", "DigitalAnt", "secure-heart-state.json");
}
...
async function reconcilePending({ state, statePath, provider, heartInterface, kgen, walletAddress }) {
  ...
  const event = {
    ...
    timestamp: nowIso(), worker: "DIGITAL_ANT_SECURE_HEART_WORKER", secret_exposed: false
  };
