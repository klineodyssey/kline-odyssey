...
export * from "./registry/universe-runtime.mjs?v=3.9.0-autonomous-field-service";
...
export * from "./life/starforge-body-universe.mjs";
export * from "./life/starforge-energy-wallet.mjs";
export * from "./birth/index.mjs";
export * from "./birth/digital-life-birth-resolver.mjs";
export * from "./birth/naihe-source-registry.mjs";
