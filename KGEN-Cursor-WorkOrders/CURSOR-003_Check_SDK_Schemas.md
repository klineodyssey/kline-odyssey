...
確認 SDK-001 至 SDK-010 的 JSON Schema、example JSON 與 TypeScript interface 草案合法且互相對應。
...
Return a Markdown report named `CURSOR-003_Check_SDK_Schemas_REPORT.md` with:
