# CURSOR-005_Check_No_Core_Damage
...
確認 contracts、12345、wallet、bridge、Boot、Runtime CURRENT、final-whitepaper 沒有被覆蓋或改動。
...
Return a Markdown report named `CURSOR-005_Check_No_Core_Damage_REPORT.md` with:
