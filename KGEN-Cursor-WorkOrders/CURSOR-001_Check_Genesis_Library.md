# CURSOR-001_Check_Genesis_Library
...
確認 GEN-001 至 GEN-012 的 Markdown、DOCX、PDF、README、assets/README 與索引一致。
...
Return a Markdown report named `CURSOR-001_Check_Genesis_Library_REPORT.md` with:
